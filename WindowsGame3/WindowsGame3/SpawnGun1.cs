...
namespace WindowsGame3
{
    ...
    NAME
            ...
            SpawnGun1 - A class that is in charge of when and were a gun1 object will spawn/be created.
    ...
    SYNOPSIS
        ...
        newY- Used for Generating the random Y coordinates for the gun1 spawn
    ...
    */
    ...
    class SpawnGun1 : Obj
    {
        ...
        NAME
                ...
                wave1 - A function that is called every time the game updates. Used to determine when a gun1 will spawn.
        ...
        DESCRIPTION
                ...
                This function uses the arguments that are creating in the class to determine the time it should take for each gun1 object to spawn/be created.
                ...
                It will proceed to check the objects in the object list located in the items class for an object that has the type of gun1 and if is not alive.
                Once an object is found the program will move to the while loop were it determines how many gun1's to make alive ( in this case always 1) and make solid along with the
                ...
                then they will be randomly generated again for the gun1 object to spawn in a different location. Yes this Leaves a chance that the MainPlayer can have
                this gun1 object spawn on top of them, this makes the game more random and interesting. 
        ...
        */
        ...
        NAME
                ...
                nextwave - A function that is called every time the game updates. Used to determine when a gun1 creation number is increased.
