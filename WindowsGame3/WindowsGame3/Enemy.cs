...
namespace WindowsGame3
{
    class Enemy :Obj
    {
        ...
        health - the amount of health each Enemy object has
        enemeyspd1  - the speed of the Enemy object
        MaxHp - the health of the each Enemy object as it is created
        damagedelt - the amount of damage each Enemy object deals to the Mainplayer
        hitTimer1 - the total amount of seconds until the mainplayer can be hit again
        hitTime1 -the moment it takes for the Enemy object to be able to hit the Mainplayer after already hitting the mainplayer
        DogsKilled - the total number of Enemy objects killed
        ...
        */
        ...
        DESCRIPTION
                    ...
                    When this function is called it updates the Enemy. If there are no Enemy objects alive
                    the program will then return, else it will increase the timer and call the Hitplayer function.
                    After it will check if the Enemy health has gone less then or below zero. if so the kill counts 
        ...
        */
        ...
        NAME
                ...
                Hitplayer - A function called when an Enemy comes in distance with the mainplayer
        ...
        DESCRIPTION
                    ...
                    away from then Enemy object and also it is alive. If it is alive and the hit timer is greater then hit-time, the timer will be
      ...
      Movement
        ...
        */
        ...
        // When the enemy takes damage, it subtracts the specific damage 
