...
namespace WindowsGame3
{
    ...
    NAME
            ...
            SpawnHeart - A class that is in charge of when and were a Heart object will spawn/be created.

    SYNOPSIS
     
        spawnTimer - A counter to determine how long to wait before spawning the Heart
        spawnTime - The amount of time it should take for the next Heart to spawn  
        ...
        newY- Used for Generating the random Y coordinates for the Heart spawn
     

    DESCRIPTION

     
            This class will attempt to create a Heart object at a random x and y coordinates using a SpawnHeart object. This SpawnHeart object
            uses the obj class to define its attributes. Where it is calling Move to update each time.
            SpawnHeart has the following attributes:
    ...
    */
    ...
    class SpawnHeart : Obj
    {
        ...
        NAME
                ...
                Wave1 - A function that is called every time the game updates. Used to determine when a Heart will spawn.
        ...
        DESCRIPTION
                ...
                then they will be randomly generated again for the Heart object to spawn in a different location. Yes this Leaves a chance that the MainPlayer can have
                this Heart object spawn on top of them, this makes the game more random and interesting. 
        ...
        */
        ...
        NAME
                    ...
                    nextwave - A function that is called every time the game updates. Used to determine when a heart creation number is increased.
