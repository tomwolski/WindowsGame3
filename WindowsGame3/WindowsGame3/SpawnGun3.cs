...
namespace WindowsGame3
{
    ...
    NAME
            ...
            SpawnGun3 - A class that is in charge of when and were a gun3 object will spawn/be created.
    ...
    SYNOPSIS
        ...
        waveTime  - The amount of time it should take for increasing/reseting the number of gun3 that can spawn (about 12 seconds)
        numberofGuys - The total number of gun3's that will be created on that iteration of the loop
        MakeAlive -The Number of gun3 that going to become "alive" in the loop, in this case there will only be one alive on the canvas
        newX - Used for Generating the random X coordinates for the gun3 spawn
        newY- Used for Generating the random Y coordinates for the gun3 spawn
     

    DESCRIPTION

     
            This class will attempt to create a gun3 object at a random x and y coordinates using a SpawnGun3 object. This SpawnGun3 object
            uses the obj class to define its attributes. Where it is calling Move to update each time.
            SpawnGun3 has the following attributes:
    ...
    */
    ...
    class SpawnGun3 : Obj
    {
        ...
        NAME
                ...
                wave1 - A function that is called every time the game updates. Used to determine when a gun3 will spawn.
        ...
        DESCRIPTION
                ...
                This function uses the arguments that are creating in the class to determine the time it should take for each gun3 object to spawn/be created.
                ...
                It will processed to check the objects in the object list located in the items class for an object that has the type of gun3 and if is not alive.
                Once an object is found the program will move to the while loop were it determines how many gun3's to make alive ( in this case always 1) and make solid along with the
                ...
                then they will be randomly generated again for the gun3 object to spawn in a different location. Yes this Leaves a chance that the MainPlayer can have
                this gun3 object spawn on top of them, this makes the game more random and interesting. 
        ...
        */
        ...
        NAME
                ...
                nextwave - A function that is called every time the game updates. Used to determine when a gun3 creation number is increased.
        ...
        DESCRIPTION
                ...
                This function uses the arguments that are created in the class to determine the time it should take for each gun3 object to be created.
                ...
                The number of gun3 objects that are creating stays the same, also Nextwave resets the number of gun3 objects that will spawn the next time wave1 meets its
                requirements to create more gun3 objects (there will never be more then one gun3 spawned).
