    ...
    class gun2: Obj
    {
      ...
      gun2 :Obj
        ...
        DESCRIPTION
                ...
                This class will attempt to represent the gun2 object. Every time a gun2 object is created using the
            attributes defined :
                        Solid(True) -cant be passed through by certain objects
                        position - pos (Will be a zero vector until created by the SpawnGun2 class)
