    ...
    class Gun4ShootThree: Obj
    {
      ...
      Gun4ShootThree :Obj
        ...
        NAME
                ...
                Gun4ShootThree - A class that is in charge of determining the attributes of a Gun4ShootThree object.
        ...
        DESCRIPTION
                ...
                This class will attempt to Represent the Gun4ShootThree object. Every time a Gun4ShootThree object is created using the
            attributes defined :
                         
                        position - pos (Will be a zero vector until created by the SpawnGun5 class)
                        spritename - 3shot ( the Reference to the WindowsGame3Content picture)
        ...
        */
        /**/
        public Gun4ShootThree(Vector2 pos)
            : base(pos)
        {
            position = pos;
            spriteName = "3shot";
        ...
        DESCRIPTION
                    ...
                    away from then Gun4ShootThree object and also it is alive. If it is alive the gun attributes are reset to default, then changed based on
                    the Gun4ShootThree attributes (fire rate, shootthree, distance damage). Then sets the alive value to false making the Gun4ShootThree object not displayed anymore
